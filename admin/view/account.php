<?php
    ...
    foreach ($customer_list as $item) {
        ...
        $linkEdit = '<a href="?pg=editcustomer&accountid='.$accountid.'" class="btn btn-success">Edit</a>';
        $linkDelete = '<a href="?pg=deletecustomer&accountid='.$accountid.'" class="btn btn-danger">Delete</a>';
        $customer_html .= '
            <tr>
                <td>'.$accountid.'</td>
                <td>'.$firstname.'</td>
