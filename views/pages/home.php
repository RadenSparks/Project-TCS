...
<?php
    ...
    include $rootDir."/partials/carousel.php";

    include $rootDir."/partials/card_slider.php";

    include $rootDir."/partials/suggest.php";

    include $rootDir."/partials/free_games.php";
