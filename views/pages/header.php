<header id="header">
    <ul class="nav-list">
        <li class="nav-item nav-item--no-animation">
            <a href="index.php?site=home" class="nav-link">
        ...
        <li class="nav-item">
            <a href="/Project-TCS/index.php" class="nav-link">STORE</a>
        </li>
        <li class="nav-item">
    ...
    <ul class="nav-list">
        ...
        <?php
            ...
            if((isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true)) {
                        ...
                        <a href="#" class="btn nav-link">
                            ...
                            <div class="user-menu">
                                <ul class="user-menu__list">
                                    ...
                                    <li class="user-menu__item">
                                        <a href="/Project-TCS/assets/php/logout.php" class="user-menu__link">SIGN OUT</a>
                                    </li>
                                </ul>
                            </div>
                        </a>
                ...
                echo '
                    <li class="nav-item nav-item--no-animation">
                        <a href="index.php?site=login" class="btn nav-link">
                            <i class="nav-icon fa-solid fa-user"></i>
                            SIGN IN
                        </a>
                    </li>
