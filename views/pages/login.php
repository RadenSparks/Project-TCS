        ...
        echo '
            <div class="login-form">
                ...
                <div class="dont-have-account">
                    ...
                    <a href="/Project-TCS/index.php?site=register">Sign Up</a>
                </div>
            </div>
        ';
    } else {
...
<?php
    if (isset($_POST['email']) && isset($_POST['pass'])) 
    {
        $email = $_POST['email'];
        $pass = $_POST['pass'];
        $check = mysqli_query($conn, "SELECT email, password FROM accounts WHERE email = '$email'");
        ...
        else 
        {
            ...
            if ($pass == $row['password']) 
            {
                ...
                echo '
                    <script type="text/javascript">window.location="/Project-TCS/index.php"</script>
                ';
            }
            else
            {
