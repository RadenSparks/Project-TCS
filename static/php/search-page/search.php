...
<div class="row">
  <div class="col-sm-9">
    <div class="row">
      ...
      ?>
          <a href="index.php?act=details&id=<?php echo '' . $row['gameid'] ?>" class="col-sm-3 game">
      ...
      <?php
        ...
        echo '<div class="row"> <div style="text-align: center; font-size: 30px; color: #f5f5f5;"> No results found</div> <div style="text-align: center; color: #ffffff80;">Unfortunately I could not find any results matching your search.</div></div>';
      }
      ?>
    </div>
  </div>
