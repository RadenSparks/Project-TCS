...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="static/css/browsestyle.css">
...
<body>
  ...
  document.getElementById("searchsideform").addEventListener("submit", function(event){
    ...
    window.location = "/Project-TCS/index.php?act=products&page=1&search=" + event.currentTarget.inputsearch.value+"&genre=";
  });
</script>
</body>
</html>
