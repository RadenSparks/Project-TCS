    ...
    if (isset($_COOKIE['email']) && isset($_COOKIE['password'])) {
        echo '
            <div class="login-form">
                ...
                <h6>Sign in with an TCS account</h6>
                <form id="loginModal">
                    <div class="textbox">
        ...
        echo '
            <div class="login-form">
                <div class="logo"><img src="./static/image/img-layoutold/logo.png" alt="logo"></div>
                <h6>Sign in with an TCS account</h6>
                <form id="loginModal">
                    <div class="textbox">
    ...
    <script>
        ...
        if (signinForm) {
            signinForm.onsubmit = async (e) => {
                ...
                await fetch('./static/php/signinAccount.php', {
                    method: 'POST',
                    body: body,
                }).then(response =>
                    response.json()
