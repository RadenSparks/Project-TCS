...
<main class="main">
        ...
        <div class="container-fluid p-0 w-100">
            ...
            <div class="carousel-content row w-100 m-0">
                <!-- carousel 1 -->
                ...
                <div class="dots col-3 card mb-3 bg-transparent d-flex justify-content-between align-items-start">
                    ...
                    <div
                        class="dot active row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
