                    ...
                    foreach ($data as $index => $item) {
                        if ($index <= 5) {
                            echo ' <a href="/games/61c3466f194f98e8c3efef5a">
                                        <div class="card_bar__2Jnqx"><img src="./static/img/icon/'.$item['icon'].'.jpg" alt="">
                                            <p>' . $item['gamename'] . '</p>
                                        </div>
                                    </a>';
                        }
                            ...
                            foreach ($data as $index => $item) {
                                if ($index >= 6 && $index <= 10) {
                                    echo ' <div class="mainCardContainer_card__2_wdK">
                                                ...
                                                <input type="hidden" name="image" value="./static/img/icon/'.$item['icon'].'.jpg">
                                                ...
                                                <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                                    ...
                                                    <div class="game-card_card__RBJ5f">
                                                        ...
                                                        <img src="./static/img/icon/'.$item['icon'].'.jpg">
                                        ...
                                        <form action="./index.php?act=addcart" method="post">
                                            ...
                                            <div class="secondaryCardContainer_card__Zs7RL">
                                                <div class="secondaryCard_card__37jnF">
                                                    ...
                                                    <img class="secondaryCard_banner__BzAcT" src="./static/img/first-img/'.$item['first-img'].'.jpg" alt="cardImage">
                                                        <div class="game-card_icon__o86Ds">
                                                            <input type="submit" id="submit" name="submit" value=".">
                                                        </div>
                                                    </div>
                                    ...
                                    <a href="./index.php?act=detail&&id='.$item['gameid'].'">
                                        <form action="./index.php?act=addcart" method="post">
                                            ...
                                            <div class="freeCardContainer_games_card__3xkQE">
                                                        ...
                                                        src="./static/img/icon/'.$item['icon'].'.jpg" alt="freeCardImages">
                                                        <div class="game-card_icon__o86Ds">
                                                        <input type="submit" id="submit" name="submit" value=".">
                                                        </div>
                                                        ...
                                                        <div>
                                                            <div class="mini-card_main__2JYj4">
                                                                <div class="mini-card_image_div__2NgXx">
                                                                  <img src="./static/img/icon/'.$item['icon'].'.jpg" alt="banner">
                                                                  <div class="game-card_icon__o86Ds">
                                                                       <input type="submit" id="submit" name="submit" value=".">
                                                                 </div>
                                                                </div>
