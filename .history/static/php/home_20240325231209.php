                                       ...
                                       <?php
                                        foreach($data as $index => $item) {
                                            if($index >= 6 && $index <= 10) {
                                                ...
                                                <input type="hidden" name="image" value="'.$item['first-'].'">
                                                ...
                                                <input type="submit" name="submit" value="+">
                                                    ...
                                                    <div class="game-card_card__RBJ5f">
                                                        ...
                                                        <img src="https://cdn1.epicgames.com/amaranth/offer/Ancestors_EGS_PortraitProductImage_1200x1600-1200x1600-ddddb93fd9f6c66a1a34d4be4673bf17.jpg?h=854&amp;resize=1&amp;w=640" alt="Ancestors: The Humankind Odyssey">
