                                    ...
                                    <div class="mainCardContainer_card__2_wdK">
                                        <a href="./index.php?act=detail&&id=<?php echo $item['id'] ?>">
                                            <form action="./index.php?act=addcart" method="post">
                                                ...
                                                <input type="hidden" name="publisher" value="<? echo $item['publisher'] ?>">
                                                ...
                                                <div class="game-card_card__RBJ5f">
                                                    ...
                                                    <div class="game-card_info__3_mzD">
                                                        ...
                                                        <div class="game-card_tagline_cont__2bz4d">
                                                            <p class="game-card_tagline__22z9K"><?php echo $item['developer'] ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="game-card_price__17bNm">
                                                        <div class="price-component_price__3s8s1">
                                                            <div class="price-component_blue_button__13OKH">- <?php echo $salePercent ?> %</div>
                                                            <div class="price-component_prev_price__2Pdz0">₫ <?php echo number_format($gamePrice)?> </div>
                                                            <div class="price-component_disounted_price__2aQkW">₫ <?php echo number_format($newPrice)?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
