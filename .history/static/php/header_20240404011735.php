                            ...
                            <ul class="product-list">
                                ...
                                foreach ($data as $index => $item) {
                                    if (count($data) > 0) {
                                        ...
                                        echo '<script>let searchProduct = document.querySelector(".search-product").style.display = "none"</script>';
                                    }
                                }
                                ?>
                ...
                $(document).ready(function() {
                    $('#search').on("keyup", function() {
                        ...
                        $.ajax({
                            ...
                            // Dùng nó để lấy dữ liệu người dùng nhập vào. Chứ không thể lấy một cách 
                            data: {
                                search: getName
                            },
