                            ...
                            foreach ($data as $index => $item) {
                                if ($index >= 6 && $index <= 10) {
                                    ...
                                    echo ' <div class="mainCardContainer_card__2_wdK">
                                                ...
                                                <input type="hidden" name="id" value="' . $item['gameid'] == 0 ? none . '">
                                                ...
                                                <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                                    ...
                                                    <div class="game-card_card__RBJ5f">
                                                        ...
                                                        '.$newPrice == 0 ? '<div class="price-component_blue_button__13OKH">Free</div>' ? '<div class="price-component_blue_button__13OKH">-45%</div>
