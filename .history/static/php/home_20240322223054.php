    ...
    <div class="container-fluid p-0 w-100">
                ...
                foreach ($data as $index => $item) {
                 if($index <= 4) {
                    ...
                    <div class="text-light d-flex align-items-center justify-content-start">
                        <img src="static/img/carousel-1/sideLine1/'.$item['first-img'].'" class="img-fluid side-line-img rounded p-0"
                            alt="...">
                        <p class="p-0 mx-3 my-0 side-line-text">The Callisto PrSotocol</p>
        ...
        <div class="container-fluid d-flex align-items-start justify-content-between gap-3 p-0">
            ...
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-4/game1.jpg" class="cardCover something card-img-top bg-light rounded-4" alt="...">
            ...
            <!-- card 2 -->
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-4/game2.jpg" class="cardCover something card-img-top bg-light rounded-4" alt="...">
                <div class="card-body gameInfo">
            ...
            <!-- card 3 -->
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-4/game3.jpg" class="cardCover something card-img-top bg-light rounded-4" alt="...">
                <div class="card-body gameInfo">
