                                    ...
                                    if ($gamePrice == 0) {
                                        ...
                                        <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                            ...
                                            <div class="game-card_card__RBJ5f">
                                                ...
                                                <div class="price-component_price__3s8s1">
                                                    ...
                                                    <div class="price-component_prev_price__2Pdz0">đ' . number_format($gamePrice) . ' </div>
                                                    <div class="price-component_disounted_price__2aQkW">đ' . number_format($newPrice) . ' </div>
                                                </div>
                                            </div>
                                            </div>
                                            </form>
                                        ...
                                        <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                            ...
                                            <div class="game-card_card__RBJ5f">
                                                ...
                                                <div class="game-card_price__17bNm">
                                                <div class="price-component_price__3s8s1">
                                                <div class="price-component_disounted_price__2aQkW">đ' . number_format($gamePrice) . ' </div>
                                                ...
                                                <div class="secondaryCard_content__2PuU0">
                                                    ...
                                                    <div class="secondaryCard_price__8Ht_V">
                                                        <div class="price-component_price__2hStx">
                                                            ...
                                                            <div class="price-component_prev_price__2cAB1">đ' . number_format($gamePrice) . ' </div>
                                                            <div class="price-component_disounted_price__2bFdX">đ' . number_format($newPrice) . ' </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="secondaryCardContainer_card__Zs7RL">
                                            <div class="secondaryCard_card__37jnF">
                                                ...
                                                <div class="secondaryCard_content__2PuU0">
                                                    ...
                                                    <div class="secondaryCard_price__8Ht_V">
                                                        <div class="price-component_price__2hStx">
                                                            <div class="price-component_disounted_price__2bFdX">đ' . number_format($gamePrice) . ' </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="mini-card_price__vEBTn">
                                                            <div class="price-component_price__2hStx">
                                                                ...
                                                                if ($gamePrice == 0) {
                                                                    ...
                                                                    <div class="price-component_prev_price__2cAB1">đ'.number_format($gamePrice).'
                                                                    </div>
                                                                    <div class="price-component_disounted_price__2bFdX">đ'.number_format($newPrice).'</div>';
                                                                    } else {
                                                                        echo '<div class="price-component_disounted_price__2bFdX">đ'.number_format($gamePrice).'</div>';
                                                                    }
                                                                }
                                                                ?>
                                                            </div>
                            ...
                            ?>
                                  <a href="./index.php?act=detail&&id=' . $item['gameid'] . '">
                                                <form action="./index.php?act=addcart" method="post">
                                                        ...
                                                        <input type="hidden" name="id" value= <?p$item['gameid'] . '">
                                                        <input type="hidden" name="image" value= <?p$item['first-img'] . '">
                                                        <input type="hidden" name="name" value= <?p$item['gamename'] . '">
                                                        <input type="hidden" name="price" value= <?p$item['price'] . '">
                                                        <input type="hidden" name="publisher" value= <?p$item['publisher'] . '">
                                                    <div>
                                                        <div class="mini-card_main__2JYj4">
                                                            <div class="mini-card_image_div__2NgXx">
