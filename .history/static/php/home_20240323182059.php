                    ...
                    foreach($data as $index => $item) {
                        if($index >= 14 && $index <= 17) {
                            ...
                            <div class="card-body px-0 py-4">
                                <p class="card-text m-0 p-0">'.$item['gamename'].'</p>
             ...
             <?php
                foreach($data as $index => $item) {
                    if($index >= 17 && $index <= 21) {
                        echo '   <div class="sidelineSubContainer side-line-game px-4 py-3 rounded rounded-4 d-flex align-items-center justify-content-start gap-3 text-light">
                        <div class="game-6 game-6-1" style="background-image:  url('.$item['first-img'].');">
                        </div>
                        <div class="gameText ms-3">
                            <p class="my-1">'.$item['gamename'].'</p>
               ...
               <?php
                foreach($data as $index => $item) {
                    if($index >= 22 && $index <= 26) {
                        echo ' <div class="sidelineSubContainer side-line-game px-4 py-3 rounded rounded-4 d-flex align-items-center justify-content-start gap-3 text-light">
                        <div class="game-6 game-6-1" style="background-image:  url('.$item['first-img'].'); background-position: center center">
                        </div>
                        <div class="gameText ms-3">
                            <p class="my-1">'.$item['gamename'].'</p>
                            <p class="my-2">Free</p>
