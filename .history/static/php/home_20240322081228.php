<?php
    ...
    include_once "./static/model/produ.php";
?>
...
<main class="main">
        ...
        <div class="container-fluid p-0 w-100">
            ...
            <nav class="nav-2 navbar d-flex justify-content-start align-items-center py-3 px-0 w-100">
                <ul class="d-flex align-items-center m-0 gap-3 px-0 py-3">
                    <li class="active">
                        <div
                            class="input-1-box bg-dark d-flex align-items-center justify-content-start mx-0 px-3 rounded-pill">
                ...
                <div id="carouselExampleSlidesOnly" class="col-9 p-0 carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="static/img/carousel-1/game1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="static/img/carousel-1/game2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="static/img/carousel-1/game3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
                </div>

                <!-- sideline 1 -->
                <div class="col-3 card mb-3 bg-transparent d-flex justify-content-between align-items-start">

                    <div
                        class="row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
                        <div class="text-light d-flex align-items-center justify-content-start">
                            <img src="static/img/carousel-1/sideLine1/game1.jpg" class="img-fluid side-line-img rounded p-0"
                                alt="...">
                            <p class="p-0 mx-3 my-0 side-line-text">The Callisto Protocol</p>
                    ...
                    <div
                        class="row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
                        <div class="text-light d-flex align-items-center justify-content-start">
                            <img src="static/img/carousel-1/sideLine1/game2.jpg" class="img-fluid side-line-img rounded p-0"
                                alt="...">
                            <p class="p-0 mx-3 my-0 side-line-text">STAR WARS Jedi: Survivor&#8482;</p>
                    ...
                    <div
                        class="row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
                        <div class="text-light d-flex align-items-center justify-content-start">
                            <img src="static/img/carousel-1/sideLine1/game3.jpg" class="img-fluid side-line-img rounded p-0"
                                alt="...">
                            <p class="p-0 mx-3 my-0 side-line-text">The Last Of Us&#8482; Part I</p>
                    ...
                    <div
                        class="row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
                        <div class="text-light d-flex align-items-center justify-content-start">
                            <img src="static/img/carousel-1/sideLine1/game4.jpg" class="img-fluid side-line-img rounded p-0"
                                alt="...">
                            <p class="p-0 mx-3 my-0 side-line-text">Shoulders of Giants</p>
                    ...
                    <div
                        class="row g-0 side-line-game d-flex align-items-center justify-content-start rounded-3 p-3 mx-3 w-100">
                        <div class="text-light d-flex align-items-center justify-content-start">
                            <img src="static/img/carousel-1/sideLine1/game5.jpg" class="img-fluid side-line-img rounded p-0"
                                alt="...">
                            <p class="p-0 mx-3 my-0 side-line-text">VALORANT</p>
            ...
            <div class="section3 container-fluid d-flex flex-column justify-content-center gap-3 p-0 my-5 ">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <button class="carousel-btn" type="button" data-bs-target="#carouselExample1"
                        ...
                        <div class="carousel-item active">
                            <div class="d-flex gap-3 align-items-start justify-content-between ">
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card1.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card2.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card3.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card4.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">ADD On</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card5.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/carousel-2/card6.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
            ...
            <!-- 
             ...
             -->
            <div class="container-fluid d-flex align-items-start justify-content-between gap-3 p-0">

                <!-- card 1 -->
                <div class=" section-4-card card" style="width: 28em;">
                    <img src="static/img/section-4/game1.jpg" class="cardCover something card-img-top bg-light rounded-4"
                        alt="...">
                    <div class="card-body gameInfo">
                        <h5 class="card-title text-light my-3">League of Legends - Lunar Reveal 2023</h5>
                        <p class="card-text text-secondary my-3">Celebrate a new year with enchanting experiences and
                            good fortune all around.</p>
                ...
                <!-- card 2 -->
                <div class=" section-4-card card" style="width: 28em;">
                    <img src="static/img/section-4/game2.jpg" class="cardCover something card-img-top bg-light rounded-4"
                        alt="...">
                    <div class="card-body gameInfo">
                        <h5 class="card-title text-light my-3">Honkai Impact 3rd</h5>
                        <p class="card-text text-secondary my-3">New character Herrscher of Truth debuts. Play Supply
                            event featuring her to get equipment items.</p>
                        <p class="text-light fs-4 my-3">Free</p>
                    </div>
                </div>

                <!-- card 3 -->
                <div class=" section-4-card card" style="width: 28em;">
                    <img src="static/img/section-4/game3.jpg" class="cardCover something card-img-top bg-light rounded-4"
                        alt="...">
                    <div class="card-body gameInfo">
                        <h5 class="card-title text-light my-3">Hi-Rez Publisher Weekend</h5>
                        <p class="card-text text-secondary my-3">Celebrate the SMITE World Championship with a SMITE Gem
                            Sale and amazing DLC deals across all Hi-Rez games!</p>
                        <a href="#" class="section-4-links text-light fs-4 my-3">Save Now</a>
                    </div>
                </div>
            ...
            <div class="section-5-container container-fluid text-light d-flex flex-column align-items-center ">
                ...
                <div class="d-flex align-items-start justify-content-between gap-3 w-100">
                    ...
                    <div class=" card" style="width: 20em;">
                        <img src="static/img/section-5/game1.jpg" class="section-5-img card-img-top" alt="...">
                        <button class="btn btn-primary rounded-0 py-1">Free Now</button>
                        <div class="card-body px-0 py-4">
                            <p class="card-text m-0 p-0">Divine Knockout (DKO) - Founders Edition </p>
                    ...
                    <!-- cards 2-->
                    <div class=" card" style="width: 20em;">
                        <img src="static/img/section-5/game2.jpg" class="section-5-img card-img-top" alt="...">
                        <button class="btn btn-primary rounded-0 py-1">Free Now</button>
                        <div class="card-body px-0 py-4">
                            <p class="card-text m-0 p-0">First Class Trouble</p>
                            <a href="#" class="text-white-50 m-0 p-0">Free Now - Jan 19 at 09:30 PM</a>
                        </div>
                    </div>
                    ...
                    <!-- cards 3-->
                    <div class=" card" style="width: 20em;">
                        <img src="static/img/section-5/game3.jpg" class="section-5-img card-img-top" alt="...">
                        <button class="btn btn-primary rounded-0 py-1">Free Now</button>
                        <div class="card-body px-0 py-4">
                            <p class="card-text m-0 p-0">Gamedec - Definitive Edition</p>
                            <a href="#" class="text-white-50 m-0 p-0">Free Now - Jan 19 at 09:30 PM</a>
                        </div>
                    </div>
                    ...
                    <!-- cards 4-->
                    <div class=" card" style="width: 20em;">
                        <img src="static/img/section-5/game4.jpg" class="section-5-img card-img-top" alt="...">
                        <button class="btn text-light rounded-0 py-1" style="background-color: black;">COMING
                            SOON</button>
                        <div class="card-body px-0 py-4">
                            <p class="card-text m-0 p-0">Epistory - Typing Chronicles</p>
                            <a href="#" class="text-white-50 m-0 p-0">Free Now - Jan 19 at 09:30 PM</a>
                        </div>
                    </div>
            ...
            <div
                class="section-6 container-fluid d-flex justify-content-between align-items-center text-light my-5 p-0">
                ...
                <div class=" section-6-1 d-flex flex-column border-end border-dark px-3">
                    ...
                    <div
                        class="sidelineSubContainer side-line-game px-4 py-3 rounded rounded-4 d-flex align-items-center justify-content-start gap-3 text-light">
            ...
            <div class="section3 container-fluid d-flex flex-column justify-content-center gap-3 p-0 my-5 ">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <button class="carousel-btn" type="button" data-bs-target="#carouselExample2"
                            data-bs-slide="prev">&lt;</button>
                        <button class="carousel-btn" type="button" data-bs-target="#carouselExample2"
                            data-bs-slide="next">&gt;</button>
                    </div>
                ...
                <div id="carouselExample2" class="carousel slide">
                    <div class="carousel-inner">
                        <div class="carousel-item  active">
                            <div class="d-flex gap-3 align-items-start justify-content-between ">
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game1.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game2.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game3.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game4.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game5.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-7/game6.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
        ...
        <div class="container-fluid d-flex align-items-stetch justify-content-between gap-3 p-0">
            ...
            <!-- section-9 card 1 -->
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-9/game1.jpg" class="cardCover something card-img-top bg-light rounded-4"
                    alt="...">
                <div class="card-body gameInfo">
            ...
            <!-- section-9 card 2 -->
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-9/game2.jpg" class="cardCover something card-img-top bg-light rounded-4"
                    alt="...">
                <div class="card-body gameInfo">
            ...
            <!-- section-9 card 3 -->
            <div class=" section-4-card card" style="width: 28em;">
                <img src="static/img/section-9/game3.jpg" class="cardCover something card-img-top bg-light rounded-4"
                    alt="...">
                <div class="card-body gameInfo">
        ...
        <div class="section3 container-fluid d-flex flex-column justify-content-center gap-3 p-0 my-5 ">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample3"
                        data-bs-slide="prev">&lt;</button>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample3"
                        data-bs-slide="next">&gt;</button>
                </div>
            ...
            <div id="carouselExample3" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex gap-3 align-items-start justify-content-between ">
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game1.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                                    <p class="card-text my-1">NHRA Championship Drag Racing - Speed For All</p>
                                    <p class="bg-dark rounded text-center px-2 py-1 mt-2 mb-2 w-50 "
                                        style="font-size: 0.8em;">NOW ON EPIC</p>
                                    <p>₹1,179</p>
                                </div>
                            </div>

                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game2.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game3.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game4.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game5.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-10/game6.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
        ...
        <div class="section3 container-fluid d-flex flex-column justify-content-center gap-3 p-0 my-5 ">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample4"
                        data-bs-slide="prev">&lt;</button>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample4"
                        data-bs-slide="next">&gt;</button>
                </div>
            ...
            <div id="carouselExample4" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex gap-3 align-items-start justify-content-between ">
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game1.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game2.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game3.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game4.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game5.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-11/game6.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item">
                            <div class="d-flex gap-3 align-items-start justify-content-between ">
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game1.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">Somerville</p>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game2.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">Tails of Iron</p>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game3.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">Century: Age of Ashes</p>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game4.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">Timberborn</p>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game5.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">GigaBash</p>
                                ...
                                <div class=" card text-bg-dark" style="width: 13.5rem;">
                                    <img src="static/img/section-11/game6.jpg"
                                        class="cardCover something card-img-top bg-light" alt="...">
                                    <div class="card-body p-1 gameInfo">
                                        <h6 class="card-title text-secondary">Base Game</h6>
                                        <p class="card-text my-1">Satisfactory</p>
        ...
        <div class="section3 container-fluid d-flex flex-column justify-content-center gap-3 p-0 my-5 ">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample5"
                        data-bs-slide="prev">&lt;</button>
                    <button class="carousel-btn" type="button" data-bs-target="#carouselExample5"
                        data-bs-slide="next">&gt;</button>
                </div>
            ...
            <div id="carouselExample5" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex gap-3 align-items-start justify-content-between ">
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game1.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game2.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game3.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game4.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                                    <p class="card-text my-1">NHRA Championship Drag Racing - Speed For All</p>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game5.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
                            ...
                            <div class=" card text-bg-dark" style="width: 13.5rem;">
                                <img src="static/img/section-12/game6.jpg" class="cardCover something card-img-top bg-light"
                                    alt="...">
                                <div class="card-body p-1 gameInfo">
                                    <h6 class="card-title text-secondary">Base Game</h6>
