                                    ...
                                    if ($gamePrice == 0) {
                                        ...
                                        <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                            ...
                                            <div class="game-card_card__RBJ5f">
                                                ...
                                                <div class="game-card_price__17bNm">
                                                <div class="price-component_price__3s8s1">
                                                    <div class="price-component_blue_button__13OKH">-' . $salePercent . '%</div>
                                        ...
                                        <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                            ...
                                            <div class="game-card_card__RBJ5f">
                                                ...
                                                <div class="game-card_price__17bNm">
                                                <div class="price-component_price__3s8s1">
                                                <div class="price-component_disounted_price__2aQkW">₫' . number_format($gamePrice) . ' </div>
                ...
                <div class="secondaryCardContainer_container__1eNx_">
                    ...
                    ?>
                            <div class="secondaryCardContainer_card__Zs7RL">
                                <a href="./index.php?act=detail&&id=<?php echo $item['gameid'] ?>">
                                    <form action="./index.php?act=addcart" method="post">

                                        <input type="hidden" name="id" value=<?php echo $item['gameid'] ?>">
                                        <input type="hidden" name="image" value="./static/img/icon/<?php echo $item['icon'] ?>">
                                        <input type="hidden" name="name" value="<?php echo $item['gamename'] ?>">
                                        ...
                                        <div class="secondaryCard_card__37jnF">
                                            <div class="secondaryCard_image_div__K_J4L">
                                                <img class="secondaryCard_banner__BzAcT" src="./static/img/first-img/<?php echo $item['first-img'] ?>" alt="cardImage">
                                                <div class="game-card_icon__o86Ds">
                                                    <input type="submit" id="submit" name="submit" value=".">
                                                </div>
                                            </div>
                                            <div class="secondaryCard_content__2PuU0">
                                                <p class="secondaryCard_title__2BECf"><?php echo $item['gamename'] ?>
                                                </p>
                                                <div>
                                                    <p class="secondaryCard_description__EaOgH"><?php echo $item['summary'] ?> </p>
                                                </div>
                                                <div class="secondaryCard_price__8Ht_V">
                                                    <div class="price-component_price__2hStx">
                                                        <?php
                                                        if ($gamePrice == 0) {
                                                            echo '<div class="price-component_blue_button__15s4b">Free</div';
                                                        } else {
                                                            if ($sale != 0) {
                                                                echo '<div class="price-component_blue_button__15s4b">-' . $salePercent . '%</div>
                                                                <div class="price-component_prev_price__2cAB1">₫' . number_format($gamePrice) . '</div>
                                                                <div class="price-component_disounted_price__2bFdX">₫' . number_format($newPrice) . '</div>';
                                                            } else {
                                                                echo '<div class="price-component_disounted_price__2bFdX">₫' . number_format($gamePrice) . '</div>';
                                                            }
                                                        }
                                                        ?>
                                                    </div>
                    ...
                    <div class="freeCardContainer_lower__1ykxY">
                        ...
                        ?>
                                <a href="./index.php?act=detail&&id=<?php echo $item['gameid']; ?>">
                                    <form action="./index.php?act=addcart" method="post">
                                        <input type="hidden" name="id" value="<?php echo $item['gameid']; ?>">
                                        <input type="hidden" name="image" value="<?php echo $item['first-img']; ?>">
                                        <input type="hidden" name="name" value="<?php echo $item['gamename']; ?>">
                                        <input type="hidden" name="price" value="<?php echo $item['price']; ?>">
                                        <input type="hidden" name="publisher" value="<?php echo $item['publisher']; ?>">
                                        <div class="freeCardContainer_games_card__3xkQE">
                                            <div class="freeCardContainer_image_div__1GQj_">
                                                <img class="freeCardContainer_banner__3cF79" src="./static/img/icon/<?php echo $item['icon']; ?>" alt="freeCardImages">
                                                <div class="game-card_icon__o86Ds">
                                                    <input type="submit" id="submit" name="submit" value=".">
                                                </div>
                                                <div class="freegames">
                                                    <?php echo ($gamePrice == 0) ? '<div class="freeCardContainer_free__16LQ5">Free Now</div>' : '<div class="freeCardContainer_coming__HQcXI">Coming Soon</div>'; ?>
                                                </div>
                                            </div>
                                            <div class="freeCardContainer_content__3nTcE">
                                                <p class="freeCardContainer_heading__34Fh-"><?php echo $item['gamename']; ?></p>
                                                <p class="freeCardContainer_subheading__2J3yu"><?php echo ($gamePrice == 0) ? 'Free Now' : 'Coming Soon'; ?> - Dec 19 at 09:30 PM</p>
                                            </div>
                                        </div>
                                    </form>
                                </a>
                            ...
                            ?>
                                    <a href="./index.php?act=detail&&id=<?php echo $item['gameid'] ?>">
                                        <form action="./index.php?act=addcart" method="post">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $item['gameid'] ?>">
                                            <input type="hidden" name="image" value="<?php echo $item['first-img'] ?>">
                                            <input type="hidden" name="name" value="<?php $item['gamename'] ?>">
                                            <input type="hidden" name="price" value="<?php echo $item['price'] ?>">
                                            <input type="hidden" name="publisher" value="<?php echo $item['publisher'] ?>">
                                            <div>
                                                <div class="mini-card_main__2JYj4">
                                                    <div class="mini-card_image_div__2NgXx">
                                                        <img src="./static/img/icon/<?php echo $item['icon'] ?>" alt="banner">
                                                        <div class="game-card_icon__o86Ds">
                                                            <input type="submit" id="submit" name="submit" value=".">
                                                        </div>
                                                    </div>
                                                    <div class="mini-card_content__2TxHx">
                                                        <div>
                                                            <p class="mini-card_heading__33gAB"><?php echo $item['gamename'] ?></p>
                                                        </div>
                                                        <div class="mini-card_price__vEBTn">
                                                            <div class="price-component_price__2hStx">
                                                                <?php
                                                                if ($gamePrice == 0) {
                                                                    echo '<div class="price-component_blue_button__15s4b">Free
                                                                </div>';
                                                                } else {
                                                                    if ($sale != 0) {
                                                                        echo '  <div class="price-component_blue_button__15s4b">-' . $salePercent . '%
                                                                    </div>
                                                                    <div class="price-component_prev_price__2cAB1">₫' . number_format($gamePrice) . '
                                                                    </div>
                                                                    <div class="price-component_disounted_price__2bFdX">₫' . number_format($newPrice) . '</div>';
                                                                    } else {
                                                                        echo '<div class="price-component_disounted_price__2bFdX">₫' . number_format($gamePrice) . '</div>';
                                    ...
                                    <div class="mainCardContainer_card__2_wdK">
                                        ...
                                        <a href="./index.php?act=detail&&id=<?php echo $item['gameid'] ?>">
                                            <form action="./index.php?act=addcart" method="post">
                                                ...
                                                <div class="game-card_card__RBJ5f">
                                                    <div class="game-card_image_div__3GP6O">
                                                        <img src="./static/img/icon/<?php echo $item['icon']?>">
                                                        <div class="game-card_icon__o86Ds">
                                                            <input type="submit" id="submit" name="submit" value=".">
                                                        </div>
                                                    </div>
                                                    <div class="game-card_info__3_mzD">
                                                        <p class="game-card_title__3klhw"><?php echo $item['gamename']?></p>
                                                        <div class="game-card_tagline_cont__2bz4d">
                                                            <p class="game-card_tagline__22z9K"><?php echo $item['developer']?> | <?php echo $item['publisher']?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="game-card_price__17bNm">
                                                        <div class="price-component_price__3s8s1">
                                                           <?php
                                                            if($gamePrice == 0) {
                                                                ...
                                                                if($sale != 0) {
                                                                    echo ' <div class="price-component_blue_button__13OKH">-'.$sale.'%</div>
                                                                    <div class="price-component_prev_price__2Pdz0">₹ 1979</div>
                                                                    <div class="price-component_disounted_price__2aQkW">₹ 1307</div>';
                                                                } else {
                                                                    echo ' <div class="price-component_disounted_price__2aQkW">₹ 1307
                                                                    </div>';
                                                                }
                                                            }
