                        ...
                        <div class="search">
                            <ul class="product-list">
                                ...
                                foreach ($data as $index => $item) {
                                    if (isset($data)) {
                                        if ($index >= 0 && $index <= 3) {
                                            echo '<script>const search = document.querySelector(".search-product").style.display = "block"</script>';
                                            echo ' <li>
                                        <div>
                                        ...
                                        echo '<script>const search = document.querySelector(".search-product").style.display = "none"</script>';
                                    }
                                }
                                ?>
