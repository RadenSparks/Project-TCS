                ...
                foreach($data as $index => $item) {
                    if($index >= 17 && $index <= 21) {
                        ...
                        <div class="gameText ms-3">
                            <p class="my-1">   <div class="sidelineSubContainer side-line-game px-4 py-3 rounded rounded-4 d-flex align-items-center justify-content-start gap-3 text-light">
