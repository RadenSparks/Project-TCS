                                    ...
                                    if ($gamePrice == 0) {
                                        ...
                                        <input type="hidden" name="publisher" value="' . $item['publisher'] . '">
                                            ...
                                            <div class="game-card_card__RBJ5f">
                                                ...
                                                <div class="game-card_price__17bNm">
                                                <div class="price-component_price__3s8s1">
                                                <div class="price-component_disounted_price__2aQkW">' . number_format($gamePrice) . ' vnđ</div>
                                                ...
                                                <div class="secondaryCard_content__2PuU0">
                                                    ...
                                                    <div class="secondaryCard_price__8Ht_V">
                                                        <div class="price-component_price__2hStx">
                                                            ...
                                                            <div class="price-component_prev_price__2cAB1">' . number_format($gamePrice) . ' vnđ</div>
                                                            <div class="price-component_disounted_price__2bFdX">' . number_format($newPrice) . ' vnđ</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="secondaryCardContainer_card__Zs7RL">
                                            <div class="secondaryCard_card__37jnF">
                                                ...
                                                <div class="secondaryCard_content__2PuU0">
                                                    ...
                                                    <div class="secondaryCard_price__8Ht_V">
                                                        <div class="price-component_price__2hStx">
                                                            <div class="price-component_disounted_price__2bFdX">' . number_format($gamePrice) . ' vnđ</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
