                ...
                <div class="sub-navbar_left__1pAwu">
                    <form method="post">
                        <div class="sub-navbar_search_box__8UOVU">
                            ...
                            <input type="text" name="input-search" placeholder="Search" name="content_search">
                        </div>
                    </form>
                    <?php
                        ...
                        <div class="search">
                            <ul class="product-list">
                                ...
                                foreach ($data as $index => $item) {
                                    if (isset($data)) {
                                        if ($index >= 0 && $index <= 3) {
                                            echo '<script>const search = docuement.querySelector(".search-product").style.display = "block"</script>';
                                            echo ' <li>
                                        <div>
                                            <a href="./index.php?act=detail&&id='.$gameid.'">
                                        ...
                                        echo '<script>const search = docuement.querySelector(".search-product").style.display = "none"</script>';
                                    }
                                }
                                ?>
