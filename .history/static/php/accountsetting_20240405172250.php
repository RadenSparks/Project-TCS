...
<body>
    <div class="container">
        <div class="nav_bar">
            ...
            <div class="trans"><a href="./index.php?act=transaction">Transactions</a></div>
        </div>
        <div class="accountsetting">
            ...
            <form id="newpass_form" action="./static/php/handleAccount.php">
                ...
                <div class="input_group">
                    ...
                    <input id="confirmnewpass" type="password" name="confirmnewpass">
                </div>
                <input type="submit" class= name="save-btn" value="Save Changes">
            </form>
        </div>
    </div>
</body>
