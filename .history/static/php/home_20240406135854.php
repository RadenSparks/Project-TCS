                    ...
                    <div class="mainCardContainer_mainCardContainer__308RZ">
                        <div class="mainCardContainer_container__j2ttT">
                            ...
                            <div class="mainCardContainer_card__2_wdK">
                                        ...
                                        <input type="hidden" name="id" value="<?php  $item['gameid'] . '">
                                        <input type="hidden" name="image" value="./static/img/icon/' . $item['icon'] . '">
                                        <input type="hidden" name="name" value="<?php  $item['gamename'] . '">
                                        <input type="hidden" name="price" value="<?php  $item['price'] . '">
                                        <input type="hidden" name="publisher" value="<?php  $item['publisher'] . '">
