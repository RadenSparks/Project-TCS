                                        ...
                                        <?php
                                            foreach($data as $index => $item) {
                                                if($index >= 28 && $index <= 32) {
                                                    echo '<a href="/games/61c3466f194f98e8c3efef65">
                                                    <div>
                                                        <div class="mini-card_main__2JYj4">
                                                            <div class="mini-card_image_div__2NgXx">
                                                            <img src="https://cdn1.epicgames.com/0a84818055e740a7be21a2e5b6162703/offer/WatchDogs_Legion_Store_Portrait_1200x1600-1200x1600-a6b2d4cce489aeeb87bad4a6db168bed.jpg?h=854&amp;resize=1&amp;w=640" alt="banner"></div>
                                                            <div class="mini-card_content__2TxHx">
                                                                <div>
