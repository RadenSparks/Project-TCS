                        ...
                        foreach ($data as $index => $item) {
                            if ($index >= 13 && $index <= 17) {
                                ...
                                echo '   
                                    ...
                                    ';
                                echo '<script>
                                const freegames = document.querySelector(".freegames");
                                '.$gamePrice == 0 ? '<div class="freeCardContainer_free__16LQ5">Free Now</div>' : '<div class="freeCardContainer_coming__HQcXI">Coming Soon</div>'.'
                                </script>'
                            }
                        }
                        ?>
