                    ...
                    if ($products) {
                        foreach ($products as $row) {
                            ...
                            if ($count > 0) {
                                ...
                                echo "<td><img src='./img/first-img/" . upLoadImgProduct($row['gameid']) . "'></td>";
                                echo "<td>" . $row['developer'] . "</td>";
                                echo "<td>" . $row['publisher'] . "</td>";
                                echo "<td>" . $row['tag'] . "</td>";
                                echo "<td class='operation'>";
                                echo "<div class='btn-container'>";
                                echo "<a href='?pg=product_edit&gameid=" . $row['gameid'] . "' class='btn btn-primary'>Edit</a>";
                                echo "<a href='?pg=product_list&delete=true&gameid=" . $row['gameid'] . "' class='btn btn-danger'>Delete</a>";
                                echo "</div>";
                                echo "</td>";
                                echo "</tr>";
                            }
