<?php
require_once 'model/product_edit.php';
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:250px;" src="<?php echo "./img/icon/" . $image_edit['icon'] . "" ?>"
                            alt="">
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/first-img/" . $image_edit['firstimg'] . "" ?>" alt="">
                    </div>
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/second-img/" . $image_edit['secondimg'] . "" ?>" alt="">
                    </div>
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/third-img/" . $image_edit['thirdimg'] . "" ?>" alt="">
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/fourth-img/" . $image_edit['fourthimg'] . "" ?>" alt="">
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/fifth-img/" . $image_edit['fifthimg'] . "" ?>" alt="">
                    ...
                    <div>
                        ...
                        <img style="width: 200px; height:100px;"
                            src="<?php echo "./img/logo/" . $image_edit['logo'] ?? ''; ?>" alt="">
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['editProduct_submit'])) {
    ...
    $productImg1 = $image_edit['firstimg'];
    $productImg2 = $image_edit['secondimg'];
    $productImg3 = $image_edit['thirdimg'];
    $productImg4 = $image_edit['fourthimg'];
    $productImg5 = $image_edit['fifthimg'];
    ...
    if ($stmt) {
        echo "<script>alert('Thông tin sản phẩm đã được cập nhật thành công!'); window.location.href = '?pg=product_list';</script>";
    } else {
