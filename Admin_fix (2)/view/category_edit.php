<form action="?pg=category_edit&id=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-5">
                <div>
                    <?php if (!empty($category['img'])): ?>
                        <img src="<?php echo "./img/genre-img/" . $category['img']; ?>" alt="" width="80%" height="auto">
                    <?php else: ?>
